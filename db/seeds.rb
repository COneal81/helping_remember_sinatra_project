doug = User.create(username: "dougp210", email: "doug@doug.com", password: "doug")

oma = User.create(username: "francinesgarden", email: "oma@oma.com", password: "oma")
...
Memory.create(title: "Airplane", description: "You once owned a Cesna P210 airplane that you enjoyed flying 
    ...
    date: "1995 - 2001", image_url: "www.pics.com/dougp210" , user_id: doug.id, category_id: hobbies.id)
...
Memory.create(title: "Hidden Garden", description: "At your home on Park Road in Oakwood, you used to have an area at the very
    ...
    "www.pics.com/oma/hidden_garden", user_id: oma.id, category_id: hobbies.id)
